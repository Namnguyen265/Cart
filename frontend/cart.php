					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="cart.php" class = "cart_qty"><i class="fa fa-shopping-cart"></i> Cart <?php echo "(".$tongsp.")"?></a></li>
					...
					<tbody>
						...
						?>
							...
							<tr>
								...
								<td class="cart_product">
									<p class = "id_product"><?php echo $value['id'] ?></h4>
								</td>
								<td class="cart_description">
				...
				<div class="col-sm-6">
					<div class="total_area">
						<ul>
							...
							<li class = 'final'>Total <span><?php echo $total ?></span></li>
							<li>Total product<span><?php echo $quantity ?></span></li>
						</ul>
